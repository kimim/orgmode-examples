...
Install TexLive[fn:3] to ~<texlive-path>~ and clone beamertheme-kimim[fn:4], and
update \TeX{} cache:
...
use noweb cite:ramsey1994literate technique here to add code from
other place with ~<<name-of-code-snippet>>~.
...
[fn:4] https://github.com/kimim/beamertheme-kimim
